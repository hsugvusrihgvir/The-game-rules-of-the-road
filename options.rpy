...
define config.name = _("Красная Шапочка")
...
define gui.about = _p("Игра для младшего школьного возраста, которая помогает запомнить основную информацию о правилах дорожного движения для велосипедистов и правилах для пешеходов.")
...
define config.save_directory = "12345-1666809125"
